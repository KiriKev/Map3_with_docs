          ...
          <Link href={`/`} className={`${styles.logo}`}>
            <svg width="175" height="175" viewBox="0 0 175 175" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_1623_744)">
                ...
                <path d="M113.025 0.5C113.025 35.7314 138.909 63.7727 174.86 63.7727V42.2025C150.413 38.6577 136.752 24.2273 133.876 0.5H113.025Z" fill="#D1D1D8" />
                <path d="M40.4051 0.5V34.8834C40.4051 38.1699 36.877 40.2494 34.0017 38.6577L0.140625 19.9132V0.5H40.4051Z" fill="url(#paint3_linear_1623_744)" />
                ...
                <path
                  ...
                  fill="#E7EBEE"
                />
                <path d="M113.025 0.5H107.992C108.802 38.9506 133.876 69.5248 174.86 69.5248V63.7727C138.909 63.7727 113.025 35.7314 113.025 0.5Z" fill="#E7EBEE" />
                ...
                <g filter="url(#filter0_d_1623_744)">
                  ...
                  />
                  <path
                    d="M104.579 107.132C104.579 127.784 87.8374 144.526 67.1851 144.526C46.5328 144.526 29.7908 127.784 29.7908 107.132C29.7908 86.4796 46.5328 69.7376 67.1851 69.7376C87.8374 69.7376 104.579 86.4796 104.579 107.132Z"
                    fill="#157BF2"
                  />
                  <path
                    d="M73.211 112.948C73.211 109.45 70.4526 107.7 66.7523 107.7C65.7431 107.7 64.5994 107.768 63.4557 107.902V100.434C64.1957 100.569 65.6086 100.636 66.8869 100.636C69.7798 100.636 72.5382 99.0887 72.5382 95.5229C72.5382 92.3609 70.5872 90.2079 66.8196 90.2079C62.6483 90.2079 60.3609 93.4373 60.3609 98.0122L50.5382 97.6086C50.5382 88.8624 56.7278 82 67.156 82C76.9786 82 82.63 87.0459 82.63 94.5138C82.63 99.6942 78.8624 103.193 74.893 103.731C80.3425 104.606 83.6391 108.44 83.6391 113.688C83.6391 121.425 77.1131 126 67.2905 126C56.4587 126 50 120.08 50 110.661L60.0245 110.997C60.159 115.572 62.9847 117.792 67.3578 117.792C70.5872 117.792 73.211 116.11 73.211 112.948Z"
                    fill="white"
                  />
                </g>
              </g>
              <defs>
                <filter id="filter0_d_1623_744" x="17.2646" y="62.5" width="99.422" height="119.644" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                  ...
                  <feOffset dy="5.75207" />
                  <feGaussianBlur stdDeviation="2.87603" />
